        ...
        <div className="pg4_cont">
            <div className="letter">
                ...
                Aayu, I want you to go back in time when in September 2023, I texted you for the first time. The joy you had at that time, the same I feel every single day just thinking that I have you as my girlfriend, as my soulmate, as my best friend, and soon as my wife.<br/>
                    2 years back, on 29th December, we both didn't anything about each other, but it didn't take us long to get an understanding for life. We fought, we laughes, we livved together, we ate together, we slept together, we cried together, like all the humanly possible emotions, we both have seen TOGETHER.<br/>
                    ...
                    <span style={{color: "Red"}}>I love you So So S Much Baby and I know you love me too, but Yes I gaurantee, not more than me for sure. And yes, no one and literally no one can love you as much as I do you.</span>
                </div>
            </div>
            <div className="letter">
                ...
                <div style = {{marginLeft: '10%',width:'70%',backgroundColor:'#f1c1ff',fontFamily: "sans-serif", fontWeight: 'normal' ,fontSize: '25px', textAlign: 'left', padding: '2%', paddingRight:'8%', borderRadius:'10%', boxShadow: '1px 1px 10px 5px pink'}}>
                    ...
                    <div className="vows"><span className="btn_chk" onClick={handleClick2} style={{cursor: 'pointer'}}>{checked2}</span><span style={{fontWeight:'bolder'}}>Aayu, you will always stay by my sno matter how worse the fights get, no matter how much we argue, but we both will never ever block each other anywhere, and will be each other's safe space.</span></div><hr/>
